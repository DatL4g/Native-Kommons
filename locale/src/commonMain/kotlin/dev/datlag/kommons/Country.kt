    ...
    sealed interface Code {
        ...
        data class Alpha2 internal constructor(
            ...
            companion object {
                ...
                fun isValidFormat(value: CharSequence): Boolean {
                    return value.length == 2 && value.isLatinLetters()
                }
            }
        }
        ...
        data class Alpha3 internal constructor(
            ...
            companion object {
                ...
                @JvmStatic
                fun isValidFormat(value: CharSequence): Boolean {
                    return value.length == 3 && value.isLatinLetters()
                }
            }
        }
    ...
    companion object {
        ...
        fun forCodeOrNull(code: CharSequence): Country? {
            ...
            fun parseAlpha2(): Country? {
                val validCode = trimmed.takeIf(Code.Alpha2::isValidFormat) ?: return null
                return when {
                    Afghanistan.codeAlpha2.contentEquals(validCode, ignoreCase = true) -> Afghanistan
                    AlandIslands.codeAlpha2.contentEquals(validCode, ignoreCase = true) -> AlandIslands
                    ...
                    Reunion.codeAlpha2.contentEquals(validCode, ignoreCase = true) -> Reunion
                    SaintBarthelemy.codeAlpha2.contentEquals(validCode, ignoreCase = true) -> SaintBarthelemy
                    ...
                    Turkiye.codeAlpha2.contentEquals(validCode, ignoreCase = true) -> Turkiye
            ...
            fun parseAlpha3(): Country? {
                val validCode = trimmed.takeIf(Code.Alpha3::isValidFormat) ?: return null
                return when {
                    Afghanistan.codeAlpha3.contentEquals(validCode, ignoreCase = true) -> Afghanistan
                    AlandIslands.codeAlpha3.contentEquals(validCode, ignoreCase = true) -> AlandIslands
                    ...
                    Reunion.codeAlpha3.contentEquals(validCode, ignoreCase = true) -> Reunion
                    SaintBarthelemy.codeAlpha3.contentEquals(validCode, ignoreCase = true) -> SaintBarthelemy
                    ...
                    Turkiye.codeAlpha3.contentEquals(validCode, ignoreCase = true) -> Turkiye
            ...
            return trimmed.toString().toIntOrNull()?.let(::forCodeOrNull) ?: parseAlpha3() ?: parseAlpha2()
        }

        @JvmStatic
        fun forCodeOrNull(code: Int): Country? {
            val validCode = code.takeIf(Code.Numeric::isValidFormat) ?: return null
            return when (validCode) {
                Afghanistan.codeNumeric.toInt() -> Afghanistan
                AlandIslands.codeNumeric.toInt() -> AlandIslands
                ...
                Reunion.codeNumeric.toInt() -> Reunion
                SaintBarthelemy.codeNumeric.toInt() -> SaintBarthelemy
                ...
                Turkiye.codeNumeric.toInt() -> Turkiye
